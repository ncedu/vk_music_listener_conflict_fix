    ...
    <body>
        ...
        <div class="workspace">
            <div class="room-infoblock">
                <div class="room-info">
                    <input type="button" onclick="javascript:PopUpShow2();" value="Add user">
                    <input type="button" onclick="javascript:PopUpShow();" value="Add song">
                    <br>
                        <p>Room creator:
        ...
        <div class="popup2" id="popup2">
            <div class="popup-content2">
                <a href="javascript:PopUpHide2()" class="hidePopUp2">Close</a>
                <div class="message">
                    <form>
                        <p><input id="userVkId" type="text"/>User vk id</p>
                        <button id="send2" type="button"/>Add user</p>
                        <script type="text/javascript">
                            document.getElementById("send2").addEventListener("mousedown", function (event) {
                                if (event.which == 1) {
